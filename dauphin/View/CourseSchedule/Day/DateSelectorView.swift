  ...
  var body: some View {
    ...
    .background(
      RoundedRectangle(cornerRadius: 12)
        ...
        .overlay(
          RoundedRectangle(cornerRadius: 12)
            .strokeBorder((!isSelected && isToday) ? Color.accentColor.opacity(0.3) : .clear, lineWidth: 2)
        )
        .shadow(color: isSelected ? Color.accentColor.opacity(0.3) : .clear, radius: isSelected ? 4 : 0)
    )
